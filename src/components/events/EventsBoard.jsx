...
export default function EventsBoard() {
    ...
    const getEventCategoryServices = (eventId, category) => {
        ...
        const categoryEventServices = eventServices.filter(
            es => es.event_id === eventId && categoryServiceIds.includes(es.service_id) && !es.is_package_main_item && !es.is_external
        );
    ...
    const handleEditAssignment = useCallback((eventService, supplier, eventName, serviceName) => {
        ...
        const declineRecord = declinedSuppliers.find(d => d.supplier_id === supplier.id) || null;
