...
function replaceVariables(text, eventObj, supplierObj, serviceObj, userObj, resolvedServiceName, supplierNote) {
    ...
    const vars = {
        ...
        'family_name': getVal(eventObj, ['event_name', 'eventname']) || getVal(eventObj, ['family_name', 'familyname']),
        'familyname': getVal(eventObj, ['event_name', 'eventname']) || getVal(eventObj, ['family_name', 'familyname']),
