    ...
    try {
        ...
        if (GREEN_API_INSTANCE_ID && GREEN_API_TOKEN) {
            ...
            if (response.ok) {
             ...
             console.error('[HandleEntityEvents] Missing Green API Secrets');
        }
    } catch (e) {
...
function replaceVariables(text, eventObj, supplierObj, serviceObj, userObj, resolvedServiceName, supplierNote) {
    ...
    const vars = {
        ...
        'family_name': getVal(eventObj, ['family_name', 'familyname']) || getVal(eventObj, ['event_name', 'eventname']),
        'familyname': getVal(eventObj, ['family_name', 'familyname']) || getVal(eventObj, ['event_name', 'eventname']),
